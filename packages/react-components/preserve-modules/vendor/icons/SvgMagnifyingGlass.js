...
const SvgMagnifyingGlass = ({ size, theme, isAnnouncedByScreenReader = false, }) => (jsxs(Fragment, { children: [jsx(Svg, { size: size, theme: theme }), isAnnouncedByScreenReader ? (jsx("span", { css: css `
					${visuallyHidden}
				`, children: "Search" })) : ('')] }));

export { SvgMagnifyingGlass };
//# sourceMappingURL=SvgMagnifyingGlass.js.map
